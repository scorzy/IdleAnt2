export class CONSTS {
  ...
  static readonly PROD = new Decimal(20);
  static readonly CONSUME = new Decimal(-15);
  ...
  static readonly TWIN_PRICE_0 = new Decimal(500);
  static readonly TWIN_PRICE_1 = new Decimal(5e3);
  static readonly TWIN_PRICE_2 = new Decimal(5e4);
  static readonly TWIN_PRICE_3 = new Decimal(5e5);
}
