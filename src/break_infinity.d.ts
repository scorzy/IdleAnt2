...
declare class Decimal {
  ...
  static fromMantissaExponent_noNormalize(
    mantissa: number,
    exponent: number
  ): Decimal;
  ...
  static cmp_tolerance(
    value: DecimalSource,
    other: DecimalSource,
    tolerance: DecimalSource
  ): 1 | 0 | -1;
  static compare_tolerance(
    value: DecimalSource,
    other: DecimalSource,
    tolerance: DecimalSource
  ): 1 | 0 | -1;
  ...
  static equals_tolerance(
    value: DecimalSource,
    other: DecimalSource,
    tolerance: DecimalSource
  ): boolean;
  static neq_tolerance(
    value: DecimalSource,
    other: DecimalSource,
    tolerance: DecimalSource
  ): boolean;
  static notEquals_tolerance(
    value: DecimalSource,
    other: DecimalSource,
    tolerance: DecimalSource
  ): boolean;
  ...
  static efficiencyOfPurchase(
    cost: DecimalSource,
    current_RpS: DecimalSource,
    delta_RpS: DecimalSource
  ): Decimal;
